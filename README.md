...
`pyproject.toml` pinuje źródła Git tagami i rewizjami, nie branchem `main`: `app-factory` `v0.6.5`, `my-auth` `v0.4.2`, `posejdon` `v0.1.0`, a `fala-runtime` i `doctotext` po `rev`. `uv.lock` przypina konkretne commity.
